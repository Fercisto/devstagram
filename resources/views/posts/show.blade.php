        ...
        <div class="md:w-1/2 p-5">
            ...
            <div class="shadow bg-white p-5 mb-5">
                ...
                @auth
                    ...
                    @if (session('mensaje'))
                        <div class="bg-green-500 p-2 roundend-lg mb-6 text-white text-center uppercase font-bold">{{ session('mensaje') }}</div>
                    @endif
                    ...
                    <form action="{{ route('comentarios.store', ['post' => $post, 'user' => $user ]) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <label for="comentario" class="mb-2 block uppercase font-bold">
                                Comentario
                            </label>
